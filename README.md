...
Total de semestres da graduação

Semestre atual

O sistema calcula o progresso usando a fórmula:

progresso = (semestre atual / total de semestres) * 100
...
adicionar conquistas (estilo gamificação)
